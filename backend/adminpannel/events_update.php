...
if(isset($_POST['flag']) && $_POST['flag']=='update')
{
	...
	if(isset($_POST['check']))
	{
		...
		unlink("../img_upload/events/".$_POST['imgx']);
		 
		 $sql="update `events` set `name`='".$_POST['name']."',`description`='".$_POST['des']."',`doe`='".$_POST['doe']."',`images`='".$_FILES['pic']['name']."' where `id`=".$id;
	}
	else
	{ 	
$sql="update `events` set `name`='".$_POST['name']."',`description`='".$_POST['des']."',`doe`='".$_POST['doe']."' where `id`=".$id;
}
		 ...
		 {
			ob_clean();
			header('location:manage_event.php?msg=Record Updated');
		 }
		 else
		 {
			 header('location:manage_event.php?msg=Record not Updated');
		 }
...
<center><div id="contentt">
	<div class="wrap-inn">
		<h2 style="font-size:40px;color: #006699;text-align:center"><b><u>Update Events Details</u></b></h2>
	...
	<form action="" method="POST" enctype="multipart/form-data">
		...
		<div class="element">
			...
			<img src="../img_upload/events/<?php echo $news[0]['images'];?>"/>		
		</div>
		<div class="element">
		...
		<div class="element">
		<input type="hidden" name="imgx" value="<?php echo $news[0]['images'];?>">
