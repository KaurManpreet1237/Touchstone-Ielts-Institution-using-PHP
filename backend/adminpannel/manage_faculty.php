...
<body>
	<h2 style="font-size:40px;color: #006699;text-align:center;margin-top:15%;margin-bottom:-15%;"><b><u>MANAGE FACULTY</h2>
	
	<table id="tab"  border="5px" width="95%" style="background-color:#c2d6d6;">
		<tr><th>S.No</th><th>name</th><th>achievement</th><th>date of joining</th><th>images</th><th colspan=2>Operations</th></tr>
		<?php
			//$conn=connection();
			...
			foreach($news as $new)
			{
				...
				<td><?php echo $new['doj'];?></td>
				<td style="text-align:center;"><img src="../img_upload/faculty/<?php echo $new['image'];?>"width="150" height="150"></td>
				
				<td><a href='update_faculty.php?id=<?php echo $new['id'];?>&flag=Update'><h3  style="color:green;">Update</h3></a></td>
