...
<body>
<div id="join1">
	<h1 style="font-size:50px;padding-top:50px;color:white;">PTE</h1>
...
<div id="join2">
	<div class="join2-left">
		<h2 style="font-size:50px;text-align:center;color:#006699;"><u><b>PTE</b></u></h2>
		<img src="images/whypte.jpg"height="86%" width="95%">
		<h2 style="font-size:50px;color:#006699;"><u><b>What is PTE ...?</b></u></h2>
		<p>The Pearson Test of English (PTE) is the English language test for students 
		willing to study, work or locate in countries with English as their primary 
		language. This computer-based test is accepted by major educational institutions 
		in the world.

		Conducted by the Pearson PLC group, the syllabus includes day-to-day English and 
		tests students based on their ability to understand the language effectively as spoken 
		daily.
	...
	<!--<form name="form1" action="" method="POST">
		...
		<h2 style="font-size:35px;text-align:left;color:#006699;padding-bottom:17px; padding-top:8px;"><b><u>PTE Course Information</u></h2>
...
<div id="join3">
	<h1  style="font-size:40px;color: #006699;text-align:center; padding-bottom:20px"><u><b>Why PTE?</b></u></h1>

    <div class="join3-left">
	 <li>Faster results</li>
     <li>No worries about handwriting</li>
     <li>Less stress</li>
     <li>360 test dates available a year</li>
     <li>Integrated testing system for maximum accuracy</li>
     <li>Fully computer-based test</li>
	 <li>Boost English confidence for a successful future</li>
     <li>Accepted by world-class universities</li>
     <li>Multitude of international opportunities</li>
     <li>Result-oriented preparation</li>
	 </div>
	 <div class="join3-right">
		<img src="images/pte1.jpg" height="75%" width="98%";>
		<style>
